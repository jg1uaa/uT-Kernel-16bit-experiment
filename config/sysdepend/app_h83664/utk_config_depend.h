...
/*
 *	utk_config_depend.h (h83664)
 *	System Configuration Definition
 */

/* ROMINFO */
#define SYSTEMAREA_TOP	0x0000f780	/* RAM system area top */
#define SYSTEMAREA_END	0x0000fec0	/* RAM system area end */

/* User definition */
#define RI_USERAREA_TOP	0x0000ff80	/* RAM user area top */
#define RI_USERINIT	NULL	/* User initialization program */

/* Stacks */
#define RI_INTSTACK	0x0000ff80 /* Interrupt stack top(internal RAM end) */


/* SYSCONF */
#define CFN_TIMER_PERIOD	250
...
#define CFN_REALMEMEND		((VP)0xff80)

...
/*
 * TCB Offset Definition (for cpu_support.S)
 */
EXPORT	const UH	TCB_tskid = offsetof(TCB, tskid);
EXPORT	const UH	TCB_state = offsetof(TCB, state);
EXPORT	const UH	CTXB_ssp = offsetof(TCB, tskctxb.ssp);
